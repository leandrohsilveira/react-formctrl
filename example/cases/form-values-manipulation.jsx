...
function SampleForm({ formName, formCtrl, onSubmit }) {
    return (
        <Form name={formName} onSubmit={onSubmit}>
            <InputField label="Name (required)" formName={formName} fieldName="name" required />
            <InputField label="E-mail (email and required)" formName={formName} fieldName="email" type="email" required />
            <InputField label="Age (number and required)" formName={formName} fieldName="age" type="number" required />
